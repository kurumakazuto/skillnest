...
function Mt(e, t) {
  ...
  if (
    ((f += A), (R.precision = f), (r = xe(N)), (n = r.charAt(0)), (o = G(v)), Math.abs(o) < 15e14)
  ) {
  ...
  uo = be(() => {
    ...
    C.toDecimalPlaces = C.todp = function (e, t) {
      ...
      return (
        ...
        e === void 0
          ? r
          : (Ee(e, 0, at), t === void 0 ? (t = n.rounding) : Ee(t, 0, 8), _(r, e + G(r) + 1, t))
      )
    }
    ...
    ke = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (
          m = n.e - i.e, ge = J.length, Qe = we.length, v = new yr($l), N = v.d = [], f = 0;
          J[f] == (we[f] || 0);
        )
          ++f
        if (
